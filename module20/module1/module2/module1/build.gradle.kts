...
dependencies {
    ...
    androidTestImplementation(project(":module20:module1:module1:module3"))
    androidTestImplementation(project(":module20:module1:module2:module3"))
    ...
    implementation(project(":module20:module1:module2:module4"))
...
android {
    namespace = "pkg.android.module20.module1.module2.module1"
}
