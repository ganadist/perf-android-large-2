...
dependencies {
    ...
    androidTestImplementation(project(":module20:module1:module1:module6"))
    ...
    implementation(project(":module20:module1:module1:module7"))
...
android {
    namespace = "pkg.android.module20.module1.module1.module1"
}
