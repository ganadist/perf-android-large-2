...
dependencies {
    api(project(":module02:module24:module2:module2"))
    ...
    implementation(project(":module02:module24:module2:module2"))
...
android {
    namespace = "pkg.android.module02.module24.module2.module3"
}
