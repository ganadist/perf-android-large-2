...
dependencies {
    ...
    androidTestImplementation(project(":module02:module05"))
    ...
    androidTestImplementation(project(":module02:module30:module3"))
    androidTestImplementation(project(":module02:module32:module3"))
    androidTestImplementation(project(":module02:module33:module3"))
...
android {
    namespace = "pkg.android.module02.module02"
}
