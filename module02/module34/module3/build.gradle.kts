...
dependencies {
    ...
    api(project(":module06:module112:module3"))
    api(project(":module06:module336:module1"))
    api("org.jetbrains.kotlin:kotlin-stdlib-jdk8:${Versions.kotlin}")
    implementation(project(":module02:module34:module2"))
    implementation(project(":module02:module34:module5"))
    implementation(project(":module06:module112:module3"))
...
android {
    namespace = "pkg.android.module02.module34.module3"
}
