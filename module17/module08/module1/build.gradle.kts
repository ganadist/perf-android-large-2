...
dependencies {
    ...
    compileOnly(project(":module04:module14"))
    compileOnly(project(":module04:module20"))
    compileOnly(project(":module06:module109:module1"))
    compileOnly(project(":module06:module282:module1"))
    ...
    testImplementation(project(":module06:module282:module1"))
...
android {
    namespace = "pkg.android.module17.module08.module1"
}
