...
dependencies {
    ...
    api(project(":module22:module10:module1:module1"))
    ...
    implementation(project(":module22:module10:module1:module1"))
...
android {
    namespace = "pkg.android.module22.module10.module1.module2"
}
