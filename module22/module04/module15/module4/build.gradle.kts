...
dependencies {
    ...
    api(project(":module06:module047:module3"))
    api(project(":module06:module290:module3"))
    api(project(":module22:module04:module15:module2"))
    ...
    implementation(project(":module06:module047:module3"))
...
android {
    namespace = "pkg.android.module22.module04.module15.module4"
}
