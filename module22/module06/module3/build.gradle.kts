...
dependencies {
    ...
    api(project(":module03:module08:module1:module1"))
    ...
    api(project(":module22:module06:module2"))
    ...
    implementation(project(":module03:module08:module1:module1"))
...
android {
    namespace = "pkg.android.module22.module06.module3"
}
