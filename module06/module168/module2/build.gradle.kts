...
dependencies {
    api(project(":module06:module168:module1"))
    api(project(":module06:module168:module3"))
    ...
    implementation(project(":module06:module168:module1"))
...
android {
    namespace = "pkg.android.module06.module168.module2"
}
