...
dependencies {
    ...
    api(project(":module06:module140:module3"))
    api(project(":module06:module140:module8"))
    api(project(":module06:module138:module2"))
    ...
    implementation(project(":module06:module140:module3"))
    implementation(project(":module06:module140:module8"))
    implementation(project(":module06:module138:module2"))
...
android {
    namespace = "pkg.android.module06.module140.module7"
}
