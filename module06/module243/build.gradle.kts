...
dependencies {
    ...
    api(project(":module06:module007:module7"))
    ...
    api(project(":module06:module352:module3"))
    api(project(":module16:module1"))
    api("com.google.dagger:dagger:2.28")
    api("io.reactivex.rxjava2:rxjava:2.2.19")
    compileOnly("androidx.annotation:annotation:1.1.0")
    compileOnly("org.jetbrains:annotations:13.0")
    implementation(project(":module06:module007:module7"))
    ...
    testImplementation(project(":module06:module016:module6"))
    ...
    testImplementation(project(":module06:module318:module1"))
...
android {
    namespace = "pkg.android.module06.module243"
}
