...
dependencies {
    ...
    api(project(":module06:module237"))
    api(project(":module06:module278:module7"))
    api(project(":module06:module319:module1"))
    ...
    implementation(project(":module06:module237"))
...
android {
    namespace = "pkg.android.module06.module031.module3"
}
