...
dependencies {
    androidTestImplementation(project(":module06:module074:module6"))
    ...
    implementation(project(":module06:module074:module3"))
...
android {
    namespace = "pkg.android.module06.module074.module1"
}
