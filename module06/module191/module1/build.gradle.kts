...
dependencies {
    ...
    androidTestImplementation(project(":module06:module191:module3"))
    ...
    implementation(project(":module06:module191:module4"))
...
android {
    namespace = "pkg.android.module06.module191.module1"
}
