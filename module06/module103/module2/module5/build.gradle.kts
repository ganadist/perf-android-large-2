...
dependencies {
    api(project(":module06:module103:module2:module3"))
    ...
    implementation(project(":module06:module103:module2:module3"))
...
android {
    namespace = "pkg.android.module06.module103.module2.module5"
}
