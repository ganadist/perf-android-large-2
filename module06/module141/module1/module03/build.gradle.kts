...
dependencies {
    ...
    api(project(":module06:module141:module1:module02"))
    ...
    implementation(project(":module06:module141:module1:module02"))
...
android {
    namespace = "pkg.android.module06.module141.module1.module03"
}
