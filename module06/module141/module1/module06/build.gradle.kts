...
dependencies {
    ...
    api(project(":module06:module141:module1:module05"))
    ...
    implementation(project(":module06:module141:module1:module05"))
...
android {
    namespace = "pkg.android.module06.module141.module1.module06"
}
