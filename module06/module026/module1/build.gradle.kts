...
dependencies {
    ...
    androidTestImplementation(project(":module07:module09:module4"))
    ...
    implementation(project(":module06:module164:module3"))
...
android {
    namespace = "pkg.android.module06.module026.module1"
}
