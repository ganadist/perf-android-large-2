...
dependencies {
    ...
    implementation(project(":module06:module041:module3"))
    implementation(project(":module06:module041:module8"))
    implementation(project(":module06:module041:module9"))
    implementation(project(":module06:module061:module2"))
    implementation(project(":module06:module078:module2"))
...
android {
    namespace = "pkg.android.module06.module041.module1"
}
