...
dependencies {
    api(project(":module06:module041:module2"))
    api(project(":module06:module041:module9"))
    api(project(":module06:module336:module1"))
    api(libs.kotlin.stdlib)
    implementation(project(":module06:module041:module2"))
    implementation(project(":module06:module041:module4"))
...
android {
    namespace = "pkg.android.module06.module041.module7"
}
