...
dependencies {
    ...
    api("com.squareup.workflow:workflow-ui-modal-common-jvm:0.23.2")
    ...
    implementation("com.squareup.workflow:workflow-ui-modal-common-jvm:0.23.2")
...
android {
    namespace = "pkg.android.module06.module278.module3"
}
