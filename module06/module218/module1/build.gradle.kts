...
dependencies {
    ...
    androidTestImplementation(project(":module06:module218:module4"))
    ...
    implementation(project(":module06:module218:module2"))
    implementation(project(":module06:module218:module5"))
...
android {
    namespace = "pkg.android.module06.module218.module1"
}
