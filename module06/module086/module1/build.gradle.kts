...
dependencies {
    ...
    api(project(":module06:module353:module4"))
    api("com.squareup.workflow:workflow-ui-backstack-android:0.23.2")
    ...
    implementation(project(":module06:module353:module4"))
...
android {
    namespace = "pkg.android.module06.module086.module1"
}
