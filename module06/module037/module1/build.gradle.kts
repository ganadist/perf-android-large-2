...
dependencies {
    androidTestImplementation(project(":module06:module037:module3"))
    ...
    implementation(project(":module06:module037:module4"))
...
android {
    namespace = "pkg.android.module06.module037.module1"
}
