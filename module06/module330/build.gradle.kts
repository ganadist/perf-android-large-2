...
dependencies {
    ...
    testImplementation(project(":module01:module02"))
    ...
    testImplementation(project(":module06:module030"))
    testImplementation(project(":module06:module048"))
    ...
    testImplementation(project(":module06:module331"))
    testImplementation(project(":module06:module333:module5"))
    testImplementation(project(":module06:module342:module4"))
    testImplementation(project(":module06:module339:module2"))
    testImplementation(project(":module06:module339:module3:module1"))
    testImplementation(project(":module06:module357"))
...
android {
    namespace = "pkg.android.module06.module330"
}
