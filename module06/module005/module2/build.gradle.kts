...
dependencies {
    ...
    api(project(":module06:module005:module5"))
    api(project(":module06:module336:module1"))
    api("org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.3.72")
    implementation(project(":module06:module005:module1"))
    implementation(project(":module06:module005:module4"))
    implementation(project(":module06:module005:module5"))
...
android {
    namespace = "pkg.android.module06.module005.module2"
}
