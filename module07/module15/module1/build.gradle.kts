...
dependencies {
    ...
    androidTestImplementation(project(":module07:module15:module4"))
    ...
    api(project(":module07:module15:module8"))
    ...
    implementation(project(":module06:module065:module2"))
...
android {
    namespace = "pkg.android.module07.module15.module1"
}
