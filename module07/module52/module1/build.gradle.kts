...
dependencies {
    ...
    androidTestImplementation(project(":module06:module214:module1"))
    ...
    implementation(project(":module06:module072:module3"))
    ...
    implementation(project(":module06:module214:module3"))
    implementation(project(":module06:module243"))
    implementation(project(":module06:module258:module3"))
    implementation(project(":module06:module257:module2"))
    implementation(project(":module06:module260"))
    implementation(project(":module07:module52:module4"))
...
android {
    namespace = "pkg.android.module07.module52.module1"
}
