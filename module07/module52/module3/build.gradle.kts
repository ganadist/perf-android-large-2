...
dependencies {
    api(project(":module06:module214:module1"))
    ...
    implementation(project(":module06:module214:module1"))
    implementation(project(":module06:module336:module1"))
    implementation(project(":module06:module347"))
    implementation(project(":module07:module52:module2"))
...
android {
    namespace = "pkg.android.module07.module52.module3"
}
