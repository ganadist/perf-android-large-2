...
dependencies {
    ...
    implementation(project(":module06:module019:module3"))
    implementation(project(":module06:module061:module4"))
    implementation(project(":module06:module070:module4"))
    ...
    implementation(project(":module06:module132:module1"))
    implementation(project(":module06:module143:module4"))
    implementation(project(":module06:module163:module4"))
    implementation(project(":module06:module204:module5"))
    implementation(project(":module06:module207"))
    implementation(project(":module06:module220:module3"))
    implementation(project(":module06:module221:module3"))
    implementation(project(":module06:module219:module5"))
    implementation(project(":module06:module259:module3"))
    implementation(project(":module06:module297:module2"))
    implementation(project(":module06:module298:module2"))
    implementation(project(":module06:module341:module1"))
    implementation(project(":module07:module57:module6"))
...
android {
    namespace = "pkg.android.module07.module57.module1"
}
