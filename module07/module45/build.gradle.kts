...
dependencies {
    ...
    api(project(":module06:module022"))
    api(project(":module06:module031:module3"))
    api(project(":module06:module179:module1"))
    api(project(":module06:module216"))
    api(project(":module06:module217:module2"))
    ...
    api("io.branch.sdk.android:library:2.18.1")
    api("io.reactivex.rxjava2:rxjava:2.2.19")
    compileOnly(project(":module06:module127"))
    ...
    implementation(project(":module06:module022"))
    ...
    implementation(project(":module06:module217:module2"))
...
android {
    namespace = "pkg.android.module07.module45"
}
