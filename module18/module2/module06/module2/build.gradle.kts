...
dependencies {
    ...
    implementation(project(":module18:module2:module06:module1"))
    implementation(project(":module18:module2:module06:module4"))
    implementation(project(":module18:module2:module16:module2"))
...
android {
    namespace = "pkg.android.module18.module2.module06.module2"
}
