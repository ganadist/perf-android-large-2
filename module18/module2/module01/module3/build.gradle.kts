...
dependencies {
    api(project(":module18:module2:module01:module1"))
    ...
    implementation(project(":module18:module2:module01:module1"))
...
android {
    namespace = "pkg.android.module18.module2.module01.module3"
}
