...
dependencies {
    api(project(":module18:module2:module32:module1"))
    ...
    implementation(project(":module18:module2:module32:module1"))
...
android {
    namespace = "pkg.android.module18.module2.module32.module3"
}
