...
dependencies {
    api(project(":module03:module04:module1:module2"))
    api(project(":module04:module10:module1"))
    api(project(":module04:module12:module5"))
    ...
    implementation(project(":module03:module04:module1:module2"))
...
android {
    namespace = "pkg.android.module03.module04.module1.module1"
}
