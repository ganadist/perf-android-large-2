...
dependencies {
    api(project(":module03:module10:module1:module3"))
    ...
    implementation(project(":module03:module10:module1:module3"))
...
android {
    namespace = "pkg.android.module03.module10.module1.module2"
}
