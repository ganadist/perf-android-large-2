...
dependencies {
    api(project(":module03:module11:module1:module3"))
    api(project(":module04:module10:module3"))
    api(project(":module04:module10:module5"))
    api(project(":module04:module12:module4"))
    ...
    api(project(":module06:module141:module1:module12"))
    ...
    implementation(project(":module03:module11:module1:module3"))
    implementation(project(":module04:module10:module3"))
    implementation(project(":module04:module10:module5"))
    implementation(project(":module04:module12:module4"))
    ...
    implementation(project(":module06:module141:module1:module12"))
    ...
    implementation(project(":module06:module213:module3"))
    implementation(project(":module06:module217:module1"))
    implementation(project(":module06:module219:module4"))
    implementation(project(":module06:module227:module2"))
    implementation(project(":module06:module228:module2"))
    implementation(project(":module06:module248:module2"))
    implementation(project(":module06:module275:module2"))
    ...
    implementation(project(":module22:module07:module20:module2"))
...
android {
    namespace = "pkg.android.module03.module11.module1.module2"
}
