...
dependencies {
    api(project(":module03:module03:module1:module2"))
    ...
    implementation(project(":module03:module03:module1:module2"))
...
android {
    namespace = "pkg.android.module03.module03.module1.module1"
}
